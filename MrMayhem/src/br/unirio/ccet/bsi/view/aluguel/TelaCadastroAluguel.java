...
public class TelaCadastroAluguel extends javax.swing.JInternalFrame {
    ...
    private void botaoEfetuarVendaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoEfetuarVendaActionPerformed
        if (formularioCadastroValidado()) {
            ...
            novoAluguel.setDataDevolucao(campoDataDevolucao.getText());
        ...
        if (!campoTipoEntrega.getSelectedItem().toString().equals("EM_MAOS")) {
            ...
            for (String cpfCliente : cpfsClientes) {
                ...
                if (dadosCliente.getCpf().equals(novoAluguel.getCpfComprador())){
                    ...
                    novaEntrega.setDataPedido(novoAluguel.getDataPedido());
    ...
    private void botaoAdicionarAListaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoAdicionarAListaActionPerformed
        if (campoCodigoProduto.getValue() != null && !campoCodigoProduto.getValue().toString().equals("") 
            ...
            for (String codProduto : codProdutos) {
                ...
                if (dadosProduto.getCodigo().equals(campoCodigoProduto.getText())){
                    Object[] dados = {dadosProduto.getCodigo(), dadosProduto.getNome(), campoQuantidadeProduto.getValue().toString(), 
                        dadosProduto.getValor(), valorDeAluguelFormatado(dadosProduto.getValor())};
    ...
    private void configurarSituacaoAluguel(Aluguel novoAluguel) {
        if (!campoDataEntrega.isEnabled()){
            novoAluguel.setSituacao(Enums.SituacoesDoAluguel.EM_DIA);
        } else {
            novoAluguel.setSituacao(Enums.SituacoesDoAluguel.PENDENTE);
        }
    }
